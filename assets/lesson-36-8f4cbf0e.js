...
function u(){const t=Number(c.value)||5,n=Number(l.value)||1;if(t<1||n<1){alert("Введіть коректні значення");return}a(n,t).then(p).catch(e=>{console.error(e),r.innerHTML="<li>Помилка завантаження</li>"})}//! ================= FETCH =================
